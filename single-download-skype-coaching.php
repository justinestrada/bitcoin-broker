...
<div class="outer-row row clearfix">
  <div class="single-download-wrapper wrapper clearfix">
    ...
    <?php get_template_part('template-parts/section', 'single-skype-coaching-navigation'); ?> 
        ...
        <div class="item-details-row row">
          <?php while( have_posts() ): the_post(); ?>
              <div id="content-id-<?php the_ID(); ?>" <?php post_class(); ?>>
                <?php get_template_part( 'template-parts/content', 'single-download-details-skype-coaching' ); ?>
