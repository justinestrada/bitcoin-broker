...
if (strpos($edd_price, '0.00') !== false) {
  $edd_price = "FREE";
    ...
    <section class="section-product clearfix <?php if ( 'Executive Performance Coaching' === get_the_title() ) { echo 'hidden'; } ?>">
      <div class="container">
          ...
          <div class="product-desc-col col-xs-12 col-sm-5">
            ...
            <?php else: ?>
              ...
              <?php if ( 'Tabula Rasa' === get_the_title() ) { ?>
                <a href="https://www.amazon.com/Tabula-Rasa-Leadership-Success-Management-ebook/dp/B01N7USNOA/" class="product-btn buy-btn" target="_blank" title="BUY ON AMAZON"><?php _e( 'BUY ON AMAZON' ); ?></a>
              <?php } else if ( 'Capture Your Career' === get_the_title() ) { ?>
                <a href="https://www.amazon.com/Capture-Your-Career-Position-Hours/dp/0991070534/" class="product-btn buy-btn" target="_blank" title="BUY ON AMAZON"><?php _e( 'BUY ON AMAZON' ); ?></a>
              <?php } ?>
