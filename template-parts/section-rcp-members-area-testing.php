...
.dashboard-content-col .dash-card {
    max-width: initial;
}
.notice {
	position: relative;
	...
	<div id="top" class="row row-offcanvas row-offcanvas-left row-eq-height">
		...
		<div class="dashboard-nav-col col-xs-6 col-sm-3 sidebar-offcanvas" id="sidebar">
		  ...
		  <div class="dashboard-nav-group list-group">
		    ...
		    <a tab="podcasts" class="list-group-item"><i class="fa fa-microphone" ></i> Podcasts</a>
		    ...
		    <a tab="profile" class="list-group-item"><i class="fa fa-user" ></i> Profile</a>
		    <a tab="account" class="list-group-item"><i class="fa fa-cogs" ></i> Account</a>
		    <a tab="logout" href="<?php echo wp_logout_url(); ?>" class="list-group-item"><i class="fa fa-power-off" ></i> Logout</a>
		    <a tab="terms" style="cursor: pointer;" class="list-group-item show-terms">Terms of Use</a>
		  </div>
		...
		<div class="dashboard-content-col col-xs-12 col-sm-9">
            ...
            <div class="notice alert alert-info">
  					  <div class="notice-content">Congratulations on making the smart decision to join the KRBE Digital Assets Group!</div>
					  	<i class="fa fa-close notice-dismiss" style="float: right; transform: rotate(90deg);"></i>
  					</div>
  				</div>
			</div>
			...
			<div id="tutorials" class="dashboard-row dashboard-tutorials-row row">
                <?php get_template_part('members-area-parts/tutorials-testing'); ?>
			</div>
	    ...
	    <div id="account" class="dashboard-row account-row row">
          ...
          <div class="dash-wrapper clearfix">
              ...
              <div class="panel panel-default">
                <div class="panel-heading" role="tab" id="headingOne">
                  <h3 class="panel-title">
                    <a role="button" data-toggle="collapse" data-parent="#accordion" href="#collapseOne" aria-expanded="false" aria-controls="collapseOne" style="font-size: 24px;" class="collapsed" >
                      <i class="fa fa-money" style="margin-right: 15px;"></i>Paid with Credit Card<i class="fa fa-caret-down rotate-this" style="float: right;"></i></a>
                    </a>
                  </h3>
                </div>
            ...
            <div class="col-xs-12" style="padding: 0;">
              <a class="h3 paid-with-cryptocurrency-btn" href="<?php echo get_site_url(); ?>/members-area/paid-with-crypto" title="Paid With Crypto" style="font-weight: bold;">
                <i class="fa fa-bitcoin" style="margin-right: 15px;"></i> Paid With Cryptocurrency</a>
            </div>
            <div class="col-xs-12">
              <p>Account Status: <span style="color: green;">Active</span><br/>
              Until: <span style="color: green;"><?php echo rcp_get_expiration_date( 0 ); ?></span></p>
            </div>
...
jQuery('.dashboard-nav-group a').on('click', function() {
	if ( ! jQuery(this).hasClass('active') && jQuery(this).attr('tab') != 'logout' && jQuery(this).attr('tab') !== 'terms'  ) {
